...
> **当前版本**: v0.6.0 | **最后更新**: 2026-07-11 | **仓库**: [github.com/HavocZhang/mmorpg](https://github.com/HavocZhang/mmorpg)
...
### v0.6 — 游戏内容 ✅ 已完成 (2026-07-11)

- [x] **新地图** — 4 张地图(新手村/森林/沙漠/地下城), 6 个传送门, 地图专属怪物
- [x] **Boss 副本** — 3 Boss(森林守护者/沙虫领主/暗黑巫妖王), 增强掉落池, 祭坛召唤机制
- [x] **经济系统** — 8 件商品商店, 购买/卖出, 击杀金币奖励
- [x] **公会系统** — 创建/加入/离开, 公会频道聊天, 成员广播通知
- [x] **好友/私聊** — `/w playername` 私聊命令, 私密频道精准投递
- [ ] **技能树** — 职业系统, 天赋加点
- [x] **PvP 竞技场** — 1v1 决斗发起/接受, PvP 伤害系统
