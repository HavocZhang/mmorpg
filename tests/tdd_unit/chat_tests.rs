...
use rust_mmo_gate::chat::ChatManager;
...
fn test_multi_channel_subscription() {
    ...
    mgr.player_online(10001);
    mgr.ensure_world_channel();
    mgr.create_channel("guild_chat", rust_mmo_gate::chat::ChannelType::Guild("test_guild".to_string()));
    mgr.create_channel("party_chat", rust_mmo_gate::chat::ChannelType::Party(99));
    mgr.join_channel(10001, "world").unwrap();
